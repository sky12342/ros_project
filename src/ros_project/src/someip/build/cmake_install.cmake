# Install script for directory: /root/catkin_ws/src/ros_project/src/someip
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/root/catkin_ws/src/ros_project/src/someip/build/client")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/client" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/client")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/client"
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/root/catkin_ws/src/ros_project/src/someip/build/server")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/server" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/server")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/server"
...
file(WRITE "/root/catkin_ws/src/ros_project/src/someip/build/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
