/****************************************************************************
** Meta object code from reading C++ file 'ros_impl.h'
**
...
#include <memory>
#include "../../../../../src/qt_ui/ros_impl.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'ros_impl.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 28, 13), // "signal_strMsg"
QT_MOC_LITERAL(4, 42, 6), // "pubMsg"
QT_MOC_LITERAL(5, 49, 3), // "msg"
QT_MOC_LITERAL(6, 53, 3) // "run"

    },
    "RosNode\0signal_rosShutdown\0\0signal_strMsg\0"
    "pubMsg\0msg\0run"
};
...
void RosNode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (RosNode::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RosNode::signal_strMsg)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RosNode::staticMetaObject = { {
    QMetaObject::SuperData::link<RosBase::staticMetaObject>(),
...
void *RosNode::qt_metacast(const char *_clname)
{
    ...
    return RosBase::qt_metacast(_clname);
}

int RosNode::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = RosBase::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 4)
...
// SIGNAL 1
void RosNode::signal_strMsg(const QString & _t1)
{
